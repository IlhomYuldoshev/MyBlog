...
const LoginForm = () => {
  ...
  const goRegistrationHandler = () => {
    mDispatch({type: ModalTypes.REGISTRATION_FORM})
  }
    ...
    <div className="login-form">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="login-form__form">
        <label className="login-form__label">
          <span>Email</span>
          {errors.email && <span className="err-span">This field is required</span>}
          <input
        ...
        <label className="login-form__label">
          <span>Password</span>
          {errors.password && <span className="err-span">This field is required</span>}
          <input
            className="login-form__input"
